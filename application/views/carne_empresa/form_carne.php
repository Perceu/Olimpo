...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form action="<?php echo site_url("/c_carne_empresa/imprimir")?>" method="post">
            <div class="form-group">
                <label for="nome">Nome</label>
                <?php 
                    foreach ($empresas as $value) {
                        $o_aluno[$value->empid] = $value->empNome;
                    }
                    echo form_dropdown('emp_id', $o_aluno,'','class="form-control js-select2"');
                ?>
            </div>
            <div class="form-group">
