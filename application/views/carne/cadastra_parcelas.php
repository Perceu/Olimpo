...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form action="<?php echo site_url("c_carne/gravar/".$carnes[0]->carNum)?>" method="post">
        <input type="hidden" name="aluId" value="<?php echo $carnes[0]->aluId ?>">
        <input type="hidden" name="curId" value="<?php echo $carnes[0]->curId ?>">
        <div class="row">
